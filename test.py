...
class Tester(object):
    def __init__(self,
        ...
        self.__nms_threshold = 0.6#cfg.TEST["NMS_THRESH"]
        ...
        self.__evalter = Evaluator(self.__model, visiual=False, iou_threshold=self.iou_threshold)
    ...
    def __load_model_weights(self, weight_path):
        ...
        chkpt = torch.load(weight, map_location=self.__device)["model"]
    ...
    def test(self):
        ...
        if self.__eval:
            ...
            with torch.no_grad():
                APs = Evaluator(self.__model, iou_threshold=self.iou_threshold).APs_voc(self.__multi_scale_test, self.__flip_test)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--weight_path', type=str, default='weight/diou/diou_47.pt', help='weight file path')
